<!-- HTML generated using hilite.me --><div style="background: #272822; overflow:auto;width:auto;border:none;border-width:.1em .1em .1em .8em;padding:.2em .6em;"><pre style="margin: 0; line-height: 125%"><span style="color: #75715e">&lt;?php</span> <span style="color: #66d9ef">include</span><span style="color: #f8f8f2">(</span><span style="color: #e6db74">&quot;includes/header_nav.php&quot;</span><span style="color: #f8f8f2">);</span> <span style="color: #75715e">?&gt;</span>
...
<span style="color: #66d9ef">if</span><span style="color: #f8f8f2">(isset($_POST[</span><span style="color: #e6db74">&#39;btnSubmit&#39;</span><span style="color: #f8f8f2">]))</span> <span style="color: #f8f8f2">{</span>
    ...
    <span style="color: #f8f8f2">$email_to</span> <span style="color: rgb(231, 95, 85)">=</span> <span style="color: #e6db74">&quot;samdonaghybell@gmail.com&quot;</span><span style="color: #f8f8f2">;</span>
    <span style="color: #f8f8f2">$subject</span> <span style="color: rgb(231, 95, 85)">=</span> <span style="color: #e6db74">&quot;Contact Submission Form&quot;</span><span style="color: #f8f8f2">;</span>
...
<span style="color: #75715e">//ERROR MESSAGES IF DIED FUCNTION IS CALLED (SEMI-REDUNDANT BECAUSE SEND BUTTON WONT BE ENABLED UNTIL INPUT FIELDS ARE FILLED CORRECTLY ANYWAY)</span>
    ...
    <span style="color: #66d9ef">if</span><span style="color: #f8f8f2">(</span><span style="color: rgb(231, 95, 85)">!</span><span style="color: #f8f8f2">isset($_POST[</span><span style="color: #e6db74">&#39;name&#39;</span><span style="color: #f8f8f2">])</span> <span style="color: rgb(231, 95, 85)">||</span>
        <span style="color: rgb(231, 95, 85)">!</span><span style="color: #f8f8f2">isset($_POST[</span><span style="color: #e6db74">&#39;email&#39;</span><span style="color: #f8f8f2">])</span> <span style="color: rgb(231, 95, 85)">||</span>
        <span style="color: rgb(231, 95, 85)">!</span><span style="color: #f8f8f2">isset($_POST[</span><span style="color: #e6db74">&#39;message&#39;</span><span style="color: #f8f8f2">]))</span> <span style="color: #f8f8f2">{</span>
...
<span style="color: #75715e">//GETTING THE NAME EMAIL PHONE MESSAGE FROM THE FORM AND PUTTING IT INTO VARIABLES</span>
    ...
    <span style="color: #f8f8f2">$phone</span> <span style="color: rgb(231, 95, 85)">=</span> <span style="color: #f8f8f2">$_POST[</span><span style="color: #e6db74">&#39;phone&#39;</span><span style="color: #f8f8f2">];</span>
    <span style="color: #f8f8f2">$message</span><span style="color: rgb(231, 95, 85)">=</span> <span style="color: #f8f8f2">$_POST[</span><span style="color: #e6db74">&#39;message&#39;</span><span style="color: #f8f8f2">];</span> <span style="color: #75715e">// required</span>
...
<span style="color: #75715e">//CHECKING TO MAKE SURE MESSAGE IS MORE THAN 2 CHARACTERS</span>
  <span style="color: #66d9ef">if</span><span style="color: #f8f8f2">(strlen($message)</span> <span style="color: rgb(231, 95, 85)">&lt;</span> <span style="color: #ae81ff">2</span><span style="color: #f8f8f2">)</span> <span style="color: #f8f8f2">{</span>
    <span style="color: #f8f8f2">$error_message</span> <span style="color: rgb(231, 95, 85)">.=</span> <span style="color: #e6db74">&#39;The message you entered does not appear to be valid.&lt;br /&gt;&#39;</span><span style="color: #f8f8f2">;</span>
  <span style="color: #f8f8f2">}</span>
...
<span style="color: #75715e">//THE FORMAT OF THE EMAIL BEING SENT. CLEAN STRING CLEANING ANY WHITE SPACE</span>
    ...
    <span style="color: #f8f8f2">$email_message</span> <span style="color: rgb(231, 95, 85)">.=</span> <span style="color: #e6db74">&quot;Phone: &quot;</span><span style="color: rgb(231, 95, 85)">.</span><span style="color: #a6e22e">clean_string</span><span style="color: #f8f8f2">($phone)</span><span style="color: rgb(231, 95, 85)">.</span><span style="color: #e6db74">&quot;</span><span style="color: #ae81ff">\n</span><span style="color: #e6db74">&quot;</span><span style="color: #f8f8f2">;</span>
    <span style="color: #f8f8f2">$email_message</span> <span style="color: rgb(231, 95, 85)">.=</span> <span style="color: #e6db74">&quot;Message: </span><span style="color: #ae81ff">\r\n</span><span style="color: #e6db74">&quot;</span><span style="color: rgb(231, 95, 85)">.</span><span style="color: #a6e22e">clean_string</span><span style="color: #f8f8f2">($message)</span><span style="color: rgb(231, 95, 85)">.</span><span style="color: #e6db74">&quot;</span><span style="color: #ae81ff">\n</span><span style="color: #e6db74">&quot;</span><span style="color: #f8f8f2">;</span>
...
&lt;h3 class=&quot;thanksmsg&quot;&gt;I&#39;ll get back to you ASAP!&lt;/h3&gt;
&lt;a href=&quot;index.php&quot;&gt;&lt;button class=&quot;btn btn-success&quot;&gt;Back&lt;/button&gt;&lt;/a&gt;

&lt;/section&gt;


<span style="color: #75715e">&lt;?php</span> <span style="color: #66d9ef">include</span><span style="color: #f8f8f2">(</span><span style="color: #e6db74">&quot;includes/footer.php&quot;</span><span style="color: #f8f8f2">);</span> <span style="color: #75715e">?&gt;</span>
