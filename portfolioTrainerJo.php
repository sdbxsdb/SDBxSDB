...
<section id="portfolioPageTemplate">
  ...
  <div class="container">
    <div id="header">
      ...
      <a href="https://github.com/sdbxsdb/Trainer-Jo" target="_blank"><i class="fab fa-github" style="font-size: 40px;"></i></a>
      <div>
        <strong>Link to the full code <a href="https://github.com/sdbxsdb/Trainer-Jo" target="_blank">here.</a></strong>
      </div>
      <br>
      <strong>Link to the full site <a href="https://sdbtrainerjo.xyz/" target="_blank">here.</a></strong>
    </div>
  </div>
