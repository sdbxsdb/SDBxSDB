...
<section id="portfolioPageTemplate">
  ...
  <div class="container">
    <div id="header">
      ...
      <div id="text">
        <p>You're waiting for a train, a train that will take you far away.   You know where you hope this train will take you, but you don't know for sure...
        <div id="spinner"></div><br><br>A bit of site inception here!   This site was created as a CV / personal CodePen website to showcase me and what I can do.  Made with HTML5, PHP, Bootstrap 4, SCSS and JavaScript/jQuery.  It's been built as a single page site bar the portfolio pages (where you are now) and the contact submission thanks page.</p>
        <br>
        ...
        <a href="https://github.com/sdbxsdb/SDBxSDB" target="_blank"><i class="fab fa-github" style="font-size: 40px;"></i></a>
        <div>
          <strong>Link to the full code <a href="https://github.com/sdbxsdb/SDBxSDB" target="_blank">here.</a></strong>
        </div>
        <br>
        <strong>Link to the full site <a href="https://sdbxsdb.com/" target="_blank">here.</a></strong>
      </div>
    </div>
